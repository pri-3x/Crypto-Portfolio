...
const NFTCard_1 = () => {
  return (
    ...
    >
      ...
      <defs>
        <clipPath id="clip0_273_2869">
          <rect width={16} height={16} className="fill-background-default" />
        </clipPath>
      </defs>
    </svg>
  );
